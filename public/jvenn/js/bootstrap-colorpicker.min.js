!function (a) {
    ...
    var b = function (a) {
        this.value = {
            ...
            b: 0,
            a: 1
        }, this.origFormat = null, a && (void 0 !== a.toLowerCase ? (a += "", this.setColor(a)) : void 0 !== a.h && (this.value = a))
    };
    b.prototype = {
        constructor: b,
        colors: {
        ...
        setColor: function (a) {
            a = a.toLowerCase().trim(), a && (this.value = this.isTransparent(a) ? {
                ...
                b: 0,
                a: 0
            } : this.stringToHSB(a) || {h: 0, s: 0, b: 0, a: 1})
        },
        ...
        stringParsers: [{
            ...
            re: /^([a-z]{3,})$/, format: "alias", parse: function (a) {
                var b = this.colorNameToHex(a[0]) || "#000000", c = this.stringParsers[6].re.exec(b),
