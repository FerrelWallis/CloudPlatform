...
(function (c) {
    ...
    c = c ? c._modules : {};
    m(c, "Extensions/Drilldown.js", [c["Core/Chart/Chart.js"], c["Core/Color.js"], c["Core/Globals.js"], c["Core/Options.js"], c["Core/Series/Point.js"],
        c["Core/Renderer/SVG/SVGRenderer.js"], c["Core/Axis/Tick.js"], c["Core/Utilities.js"]], function (c, m, p, t, y, E, A, k) {
        t = t.defaultOptions;
        var n = k.addEvent, F = k.removeEvent, B = k.animObject, u = k.extend, x = k.fireEvent, G = k.format,
            v = k.merge, C = k.objectEach, w = k.pick, H = k.syncTimeout, I = p.noop, q = p.seriesTypes;
        k = q.pie;
        q = q.column;
        var D = 1;
        u(t.lang, {drillUpText: "\u25c1 Back to {series.name}"});
        t.drilldown = {
        ...
        E.prototype.Element.prototype.fadeIn = function (a) {
            this.attr({
                opacity: .1,
                visibility: "inherit"
            }).animate({opacity: w(this.newOpacity, 1)}, a || {duration: 250})
        };
        ...
        c.prototype.addSingleSeriesAsDrilldown = function (a, b) {
            var d = a.series, f = d.xAxis, e = d.yAxis, g = [], r = [], h;
            var l =
                this.styledMode ? {colorIndex: w(a.colorIndex, d.colorIndex)} : {color: a.color || d.color};
            ...
            d.chart.series.forEach(function (a) {
                a.xAxis !== f || a.isDrilling || (a.options._ddSeriesId = a.options._ddSeriesId || D++, a.options._colorIndex = a.userOptions._colorIndex, a.options._levelNumber = a.options._levelNumber ||
                    c, h ? (g = h.levelSeries, r = h.levelSeriesOptions) : (g.push(a), a.purgedOptions = v({
            ...
            a = u({
                ...
                pointIndex: k,
                oldExtremes: {xMin: f && f.userMin, xMax: f && f.userMax, yMin: e && e.userMin, yMax: e && e.userMax},
        ...
        c.prototype.showDrillUpButton = function () {
            var a = this, b = this.getDrilldownBackText(), d = a.options.drilldown.drillUpButton, f;
            if (this.drillUpButton) this.drillUpButton.attr({text: b}).align(); else {
        ...
        c.prototype.drillUp = function () {
            if (this.drilldownLevels &&
                ...
                for (var a = this, b = a.drilldownLevels, d = b[b.length - 1].levelNumber, f = b.length, e = a.series, g, c, h, l, k = function (b) {
                    ...
                    b.pop();
                    h = c.lowerSeries;
                    if (!h.chart) for (g = e.length; g--;) if (e[g].options.id === c.lowerSeriesOptions.id && e[g].options._levelNumber ===
                        d + 1) {
                        h = e[g];
                        break
                    }
            ...
            (this.xAxis || []).forEach(function (a) {
                ...
                a.series.forEach(function (b) {
                    ...
                    for (d = 0; d < f.length; d++) {
                        ...
                        "number" !== typeof c && (c = b.pointClass.prototype.optionsToObject.call({series: b}, c), c.drilldown && (a.ddPoints[f[d]] || (a.ddPoints[f[d]] = []), a.ddPoints[f[d]].push(e ? e[d] : !0)))
                    }
                });
        ...
        q.prototype.animateDrillupTo = function (a) {
            if (!a) {
                ...
                this.points.forEach(function (a) {
                    ...
                    b && (b.hidden = "hidden" === b.attr("visibility"), b.hidden || (b.hide(), a.connector &&
                    a.connector.hide()))
                });
                H(function () {
                    b.points && b.points.forEach(function (a, b) {
                        b = b === (d && d.pointIndex) ? "show" : "fadeIn";
                        var c = "show" === b ? !0 : void 0, f = a.dataLabel;
        ...
        q.prototype.animateDrilldown = function (a) {
            var b = this, d = this.chart, c = d.drilldownLevels, e, g = B(d.options.drilldown.animation),
                r = this.xAxis, h = d.styledMode;
            a || (c.forEach(function (a) {
                ...
                var d = a.shapeArgs;
                h || (d.fill = a.color);
                a.graphic && a.graphic.attr(e).animate(u(a.shapeArgs, {fill: a.color || b.color}), g);
                a.dataLabel && a.dataLabel.fadeIn(g)
            }), delete this.animate)
        };
        q.prototype.animateDrillupFrom = function (a) {
            var b = B(this.chart.options.drilldown.animation), d = this.group, c = d !== this.chart.columnGroup,
                e = this;
            ...
            this.points.forEach(function (f) {
                var g = f.graphic, h = a.shapeArgs, l = function () {
                    g.destroy();
                    d && c && (d = d.destroy())
                };
                g && h && (delete f.graphic, e.chart.styledMode || (h.fill = a.color), b.duration ? g.animate(h, v(b, {complete: l})) : (g.attr(h), l()))
            })
        };
        k && u(k.prototype, {
            ...
            animateDrilldown: function (a) {
                ...
                if (this.center) {
                    var c = b.shapeArgs, e = c.start, g = (c.end - e) / this.points.length, k = this.chart.styledMode;
        ...
        y.prototype.doDrilldown = function (a, b, d) {
            var c = this.series.chart, e = c.options.drilldown, g = (e.series || []).length;
            c.ddDupes || (c.ddDupes = []);
            for (; g-- && !k;) if (e.series[g].id ===
                this.drilldown && -1 === c.ddDupes.indexOf(this.drilldown)) {
                var k = e.series[g];
        ...
        A.prototype.drillable = function () {
            var a = this.pos, b = this.label, d = this.axis, c = "xAxis" === d.coll && d.getDDPoints,
                e = c && d.getDDPoints(a), g = d.chart.styledMode;
            c && (b && e && e.length ? (b.drillable = !0, b.basicStyles || g || (b.basicStyles = v(b.styles)), b.addClass("highcharts-drilldown-axis-label"), b.removeOnDrillableClick && F(b.element, "click"), b.removeOnDrillableClick =
                n(b.element, "click", function (b) {
                    b.preventDefault();
        ...
        n(p.Series, "afterDrawDataLabels", function () {
            ...
            this.points.forEach(function (d) {
                var e = d.options.dataLabels, f = w(d.dlOptions, e && e.style, {});
        ...
        var z = function (a, b, c, f) {
            a[c ?
                "addClass" : "removeClass"]("highcharts-drilldown-point");
            f || a.css({cursor: b})
        };
