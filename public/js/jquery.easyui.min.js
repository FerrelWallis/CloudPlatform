...
function _84(e){
	...
	if(e.pageX>_87.left&&e.pageX<_87.left+_8a){
		...
		if(e.pageX<_87.left+_88&&e.pageX>_87.left+_88-_8a-30){
			dir+="e";
		}
	}
...
td.find("span:first").html(col.title).attr('title', col.title.replace(/<\/?[^>]*>/g,''));//去掉html标签
...
/*新加的,处理fitcolumns为true的时候，百分比显示自动调整列宽带来的性能问题*/
if (opts.autoWidthSize === true) {
