...
class GOEnrichmentRecord(object):
    ...
    _fields = "id enrichment description ratio_in_study ratio_in_pop"\
              " p_uncorrected p_bonferroni p_holm p_sidak p_fdr namespace genes_in_study".split()
...
class GOEnrichmentStudy(object):
    ...
    def __init__(self, pop, assoc, obo_dag, alpha=.05, study=None,
        ...
        #print "######### Times2"
        self.term_study, self.t2gs = count_terms(study, assoc, obo_dag)
        self.term_pop, tmp = count_terms(pop, assoc, obo_dag)
        #print "######### Times2"
        #print study
        if study:
    ...
    def run_study(self, study):
        ...
        for term in allterms:
            ...
            diffgenes_set = self.t2gs.get(term, 0)
            diffgenes = ""
            if diffgenes_set != 0:
                diffgenes = ";".join(diffgenes_set)          
            else:
                diffgenes = "n.a."

            namespace = self.obo_dag[term].namespace
            #print study_count 
            #print pop_count 
            #print diffgenes
            ...
            one_record = GOEnrichmentRecord(
                ...
                genes_in_study=diffgenes,
                namespace=namespace)

            results.append(one_record)
        #print "######Times pp111111111111"
