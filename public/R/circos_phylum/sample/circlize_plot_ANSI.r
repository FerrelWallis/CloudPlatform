...
otu_table_file <- 'F:/CloudPlatform/R/circos_species/sample/otu_table.txt'
group_file <- 'F:/CloudPlatform/R/circos_species/sample/group.txt'
taxonomy_file <- 'F:/CloudPlatform/R/circos_species/sample/taxonomy.txt'
...
####circlize 绘图
pdf('F:/CloudPlatform/R/circos_species/sample/circlize_plot.pdf', width = 20, height = 8)
