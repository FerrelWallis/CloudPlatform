...
(function (e, t) {
    ...
    function g(e, n, r) {
        ...
        var h = 0;
        var d = 0;
        if (n.sloth > n.slotw) d = n.sloth; else d = n.slotw;
        if (!r) {
            var h = 0 - d
        }
        n.slotw = d;
    ...
    function w(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (l == 12) if (r.ie9) {
                ...
                left: 0 - r.width + "px",
                rotate: r.rotate
            }, 0); else if (l == 13) if (r.ie9) w.transition({top: b + "px"}, 0); else w.transition({
                top: b + "px",
                rotate: r.rotate
            ...
            if (l == 12) E.transition({
                ...
                opacity: 1,
                rotate: 0
            }, h); else if (l == 14) E.transition({top: b + "px", opacity: 1, rotate: 0}, h)
        }
        if (l == 16) {
            ...
            if (a == 0) {
                ...
                if (u.find("img").length > 0) {
                    ...
                    if (u.find("iframe").length > 0) {
                        ...
                        if (!u.hasClass("fullscreenvideo")) u.css({
                            ...
                            height: v * r.bh + "px",
                            "white-space": "nowrap"
                        }); else u.css({width: r.startwidth * r.bw, height: r.startheight * r.bh});
                        p.width(d * r.bw);
                        p.height(v * r.bh);
                        c = p.width();
                        h = p.height()
                ...
                if (u.hasClass("randomrotate")) {
                    ...
                    if (r.ie || r.ie9) {
                        ...
                        if (u.find("iframe").length == 0) u.transition({scale: 1, rotate: 0})
                    }
                }
                if (u.hasClass("lfr")) {
        ...
        revolution: function (r) {
            ...
            return this.each(function () {
                ...
                if (!o.hasClass("revslider-initialised")) {
                    ...
                    var u = e.fn.jquery.split("."), h = parseFloat(u[0]), p = parseFloat(u[1]),
                        v = parseFloat(u[2] || "0");
                    if (h == 1 && p < 7) {
